...
int cargarListadoDeEmpleados(Employee listado[], int tam,int legajo)
{
    ...
    if(index!=-1)
    {
             listado[index]=addEmployee(legajo); // aca se guardan los datos del empleado
...
// hacer una funcion para sacar el promedio! q recorra el array de empleados y sume los .salary
